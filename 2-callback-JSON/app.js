...
// Función para simular la escritura de datos (asimilar la lectura de un archivo JSON)
function escribirDatos(callback) {
    setTimeout(() => {
        // Aquí simulas escribir en el JSON con un retraso de 1 segundo
        callback(biblioteca);
    }, 1000);
}
...
function actualizarDisponibilidad(titulo, nuevoEstado) {
    ...
    setTimeout(() => {
        ...
        {
           biblioteca.libros[i].disponible = nuevoEstado
        }
        }
    }, 1000);
}
