  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      if (mesasSolicitadas <= mesasDisponibles){
        ...
        reject("No hay mesas suficientes para su reservación");
      }
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      if(Math.floor(Math.random()*10) > 5){
        resolve(nombreCliente, mesasSolicitadas)
      } else {
        reject("La reservación falló, intente mas tarde.")
      }
...
// Llamada de prueba
hacerReserva("Juan Pérez", 3);  // Intenta hacer una reserva para 3 persona